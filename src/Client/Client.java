...
public class Client implements Constants{
    ...
    public Client(String serverName,int portNumber,GameView theView){
        ...
        readRecord = new ReadRecord(aSocket);
    }


    public void updateBoard(){
        theMessage = readRecord.readMessage();
        theView.updateBoard(theMessage.getTheBoard());
        theView.setMessageArea(theMessage.getTheMessage());
    }
    /**
